package com.java.project.api.common.exception;
...
public enum ExceptionData {
    ...
    // custom exception
    NOT_FOUND_BOARD(HttpStatus.NOT_FOUND, "CE0404", "해당 게시판을 찾을 수 없습니다."),
    NOT_FOUND_COMMENT(HttpStatus.NOT_FOUND, "CE0404", "해당 게시판을 찾을 수 없습니다.")
